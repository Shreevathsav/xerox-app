...
import com.xeroxapp.XeroxApp.token.Token;
import com.xeroxapp.XeroxApp.token.TokenRepository;
import com.xeroxapp.XeroxApp.token.TokenType;
...
public class AuthenticationService {
    ...
    public AuthenticationResponse register(RegisterRequest request) {
        System.out.println(request.getUserFcmToken());
        var user = User.builder()
                ...
                .fcmToken(request.getUserFcmToken())
                .build();
